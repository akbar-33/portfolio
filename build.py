...
EX = [
 ...
 dict(slug="ai-impact-map", letter="F", label="Market mapping",
   ...
   visuals=[QUAD]),
 dict(slug="revealed-strategy", letter="G", label="Revealed strategy",
   ...
   visuals=[MIX]),
 dict(slug="automation-stack", letter="H", label="The automation stack",
...
"revealed-strategy": dict(
  eyebrow="Exhibit G \u00b7 Revealed strategy",
...
"automation-stack": dict(
  eyebrow="Exhibit H · The automation stack",
